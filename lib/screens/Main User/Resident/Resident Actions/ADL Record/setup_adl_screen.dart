...
import 'package:caregiver_max/screens/Main%20User/Resident/Resident%20Actions/ADL%20Record/widgets/setup_adl.dart';
        ...
        body: Padding(
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                SizedBox(height: 20),
                NameExpansionTile(resident: resident),
                SizedBox(height: 30),
...
class NameExpansionTile extends StatelessWidget {
  final Resident? resident;
  const NameExpansionTile({this.resident});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: ExpansionTile(
        ...
        title: Text(
          '${resident!.residentName} (click for Details)',
          style: TextStyle(
            fontSize: 14.0,
