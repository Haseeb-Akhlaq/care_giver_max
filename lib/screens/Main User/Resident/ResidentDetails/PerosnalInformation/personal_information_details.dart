...
import 'pharmacy_expansion_tile.dart';
import 'physical_exam_tile.dart';
import 'physician_expantion_tile.dart';
import 'reiligous_expansion_tile.dart';
...
class _PersonalInformationDetailsState
  ...
  setInitialValues() {
    ...
    propertyDropDownName = widget.resident!.propertyName;

    admissionDateDisplay = widget.resident!.admissionDate!;

    dateOfBirthDisplay = widget.resident!.dateOfBirth!;
